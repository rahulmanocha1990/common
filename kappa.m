...
%           ALPHA - default=0.05.
%           option - default = 0, 1 -> to display all stats
%
%     Outputs:
...
default.values = {[],0,0.05,0};
default.values(1:nu) = args;
[x,w,alpha,option] = deal(default.values{:});
